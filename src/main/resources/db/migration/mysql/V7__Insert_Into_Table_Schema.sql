INSERT INTO rental (nameRental, internetDomain, contactAddress, owner) values
("Rent The Best", "www.rentthebest.com", "Bd. Unirii, nr. 10, Bucuresti, Bucuresti", "Popescu George");

INSERT INTO branch (address, rentalId) values
("Str. Ion Creanga, nr.1, Baia Mare, Maramures", 1),
...
INSERT INTO employee (nameEmployee, roleEmployee, branchId) values
("Sabou Bogdan", "manager", 1),
...
INSERT INTO car (model, transmission, bodyType, yearCar, status, price, branchId) values
("Audi A4", "automatic", "sedan", "2018", "available", 30, 1),
...
INSERT INTO reservation (startDate, endDate, price, branchId, customerId, carId) values
('2020-1-8', '2020-1-10', 120, 1, 1, 15),
